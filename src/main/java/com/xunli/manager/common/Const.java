package com.xunli.manager.common;
...
public class Const {
    ...
    public final static String COMMON_COLLEGE_FILE = "common_college.txt";

    public final static String GOOD_COLLEGE_FILE = "good_college.txt";

    public final static  String[] PROFESSION_1 = new String[]{"私企老板","企业高管"};

    public final static  String[] PROFESSION_2 = new String[]{"管理人员","技术骨干","项目经理"};
