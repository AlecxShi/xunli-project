...
CREATE TABLE robot_user_logins (user_id BIGINT NOT NULL PRIMARY KEY,msg_count INT NOT NULL DEFAULT 0,his_msg_count INT NOT NULL DEFAULT 0,last_modified TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP)
